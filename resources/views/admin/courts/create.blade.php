        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.courts.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf

                        <div>
                            <x-input-label for="name" :value="__('Nama Lapangan')" />
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required autofocus placeholder="Cth: Lapangan 1 (Vinyl)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="price_per_hour" class="block mt-1 w-full" type="number" name="price_per_hour" :value="old('price_per_hour')" required placeholder="Cth: 150000" />
                            <x-input-error :messages="$errors->get('price_per_hour')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="location" :value="__('Lokasi / Alamat')" />
                            <x-text-input id="location" class="block mt-1 w-full" type="text" name="location" :value="old('location')" placeholder="Cth: Jl. Raya Futsal No. 10, Semarang" />
                        ...
                        <!-- Foto Lapangan -->
                        <div>
                            <x-input-label for="photo" :value="__('Foto Lapangan (Opsional)')" />
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-md hover:border-indigo-400 transition-colors duration-200 cursor-pointer" id="drop-zone">
                                <div class="space-y-1 text-center">
                                    <div id="preview-container" class="hidden mb-4">
                                        <img id="photo-preview" src="" alt="Preview" class="mx-auto max-h-48 rounded-md object-cover">
                                    </div>
